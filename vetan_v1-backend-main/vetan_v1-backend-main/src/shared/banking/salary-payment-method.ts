...
> = {
  NEFT: {
    label: 'NEFT',
    description: 'National Electronic Funds Transfer — standard for salary (T+0/T+1)',
  },
  RTGS: {
    label: 'RTGS',
    description: 'Real Time Gross Settlement — high-value, same-day (₹2 lakh+ typically)',
  },
  IMPS: {
    label: 'IMPS',
...
/** Common Indian bank names from IFSC 4-character bank code (hint only). */
...
export function suggestBankNameFromIfsc(ifsc: string | null | undefined): string | null {
