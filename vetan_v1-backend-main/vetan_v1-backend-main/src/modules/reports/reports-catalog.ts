...
export const REPORT_CATALOG: ReportDefinition[] = [
  {
    ...
    description: 'Employee-wise gross, deductions, and net pay for a payroll run or month.',
    category: 'payroll',
    filters: [
  ...
  },
  {
    ...
    description: 'Included employees with bank account, IFSC, and net pay (ready for NEFT).',
    category: 'payroll',
    filters: [
      { key: 'periodYear', label: 'Year', type: 'year', required: true },
      { key: 'periodMonth', label: 'Month', type: 'month', required: true },
  ...
  },
  {
    ...
    description: 'Estimated PF, ESI, PT, and TDS totals for the selected payroll period.',
    category: 'statutory',
    filters: [
      { key: 'periodYear', label: 'Year', type: 'year', required: true },
      { key: 'periodMonth', label: 'Month', type: 'month', required: true },
  ...
  },
  {
    ...
    description: 'Present, absent, late, and WFH counts by employee for a month.',
    category: 'attendance',
    filters: [
      { key: 'periodYear', label: 'Year', type: 'year', required: true },
      { key: 'periodMonth', label: 'Month', type: 'month', required: true },
  ...
  },
  {
    ...
    description: 'Approved leave days by employee and leave type for the calendar year.',
    category: 'attendance',
  ...
  },
  {
    ...
    description: 'Active workforce listing with department, compensation, and bank readiness.',
    category: 'employee',
    filters: [
      {
        key: 'record',
